...
from sqlalchemy import (
    Column, BigInteger, Numeric, Text, Boolean, Integer, SmallInteger, ForeignKey,
    TIMESTAMP, text, Text,
)
...
class ExchangeStatusHistory(Base):
    ...
    event = Column(Text, nullable=False)       # "symbols_refresh", "limits_refresh"
    status = Column(Text, nullable=False)      # "ok", "error"
    message = Column(Text)                     # optional human-readable message
