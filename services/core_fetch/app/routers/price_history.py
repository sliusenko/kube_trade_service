...
from common.schemas.markethistory import PriceHistoryCreate, PriceHistoryOut
...
@router.get("/{price_id}", response_model=PriceHistoryOut)
...
@router.post("/", response_model=PriceHistoryOut)
