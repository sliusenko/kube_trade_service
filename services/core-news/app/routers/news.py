...
from app.schemas.news_sentiment import NewsSentimentCreate, NewsSentimentInDB, NewsSentimentUpdate
from app.deps.db import get_session

router = APIRouter(prefix="/news", tags=["news"])

@router.get("/", response_model=list[NewsSentimentInDB])
...
@router.get("/{news_id}", response_model=NewsSentimentInDB)
...
@router.post("/", response_model=NewsSentimentInDB)
...
@router.patch("/{news_id}", response_model=NewsSentimentInDB)
